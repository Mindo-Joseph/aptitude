export const SearchBar = ({ placeholder, onSearch, className }) => (
  <div className={`relative ${className}`}>
    <input
      ...
      className="text-base py-2 pl-10 pr-4 w-full border border-gray-300 rounded-md focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
      onKeyPress={(event) =>
